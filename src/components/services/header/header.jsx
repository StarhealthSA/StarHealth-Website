        ...
        <div className='flex justify-between items-center pt-[15px] md:pt-[30px] lg:pt-[30px] pb-[30px] md:pb-[20px] lg:pb-[30px] px-[30px] lg:px-[100px]'>
          ...
          <div className='hidden sm:flex flex-row justify-end sm:w-3/3 items-end'>
            <ul className='text-white flex flex-row sm:text-[14px] md:text-[16px] lg:text-[16px] font-medium'>
              <li>
                <Link href="/" className='md:pr-[20px] hover:text-[#d6f0e7] lg:-pr[20px]'>
                  {t('navigation.home')}
                </Link>
              </li>
              <li>
                <Link href="/about" className='md:pr-[20px] hover:text-[#d6f0e7] lg:-pr[20px]'>
                  {t('navigation.about')}
                </Link>
              </li>
              <li>
                <Link href="/services" className='md:pr-[20px] hover:text-[#d6f0e7] lg:-pr[20px]'>
                  {t('navigation.services')}
                </Link>
              </li>
              <li>
                <Link href="/doctors" className='md:pr-[20px] hover:text-[#d6f0e7] lg:-pr[20px]'>
                  {t('navigation.doctors')}
                </Link>
              </li>
              <li>
                <Link href="/blogs" className='md:pr-[20px] hover:text-[#d6f0e7] lg:-pr[20px]'>
                  {t('navigation.blogs')}
                </Link>
              </li>
              <li>
                <Link href="/contact" className='md:pr-[20px] hover:text-[#d6f0e7] lg:-pr[20px]'>
