...
function Header() {
  ...
  return (
    <>
      <div className="glass-nav sticky top-0 z-40 flex w-full justify-between items-center pt-[15px] md:pt-[30px] lg:pt-[8px] pb-[8px] md:pb-[20px] lg:pb-[8px] px-[30px] lg:px-[100px]">
        {open && (
          <div
