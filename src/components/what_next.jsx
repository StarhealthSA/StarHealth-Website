...
function WhatNext() {
  ...
  return (
    <div className="w-full bg-[#F6F4F3] pt-10 pb-10">
      <div className="mx-auto items-center flex flex-col justify-center px-[10px] lg:px-[20px]">
      ...
      <div className="flex flex-col lg:flex-row justify-center md:w-full items-center gap-[10px] lg:gap-[20px] mt-[25px] pb-[25px] md:pb-[30px] px-[20px] lg:px-[120px]">
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white flex flex-col rounded-[12px] w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="px-4 sm:px-6 lg:px-20 py-4 sm:py-6">
              <p className="text-sm sm:text-base font-normal font-inter leading-relaxed text-center text-[#687276]">
                {t('whatNextSection.modalDescription')}
              </p>
            </div>
                  ...
                  <div className="mt-0">
                    ...
                    <div className="relative">
                      <DatePicker
                        ...
                        className={`w-full py-2 lg:py-3 border border-[#DAD8D7] rounded-lg focus:outline-none text-base font-normal text-[#687276] ${isRTL ? 'pr-4 pl-32' : 'pl-4 pr-32'}`}
