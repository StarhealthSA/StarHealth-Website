...
function headerData() {
    ...
    return (
        ...
        <div>
            ...
            <div className="flex flex-col items-center mt-2 px-[30px] lg:px-[120px]">
                <h1 className="text-[24px] lg:text-[44px] text-[#002333] font-medium font-inter leading-[32px] lg:leading-[56px]">{t('doctorsPage.title')}</h1>
